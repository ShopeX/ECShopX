...
class Track extends Controller
{
     ...
     *     @SWG\Parameter( name="open_id", in="query", description="openid", required=true, type="string"),
     *     @SWG\Response(
     *         response=200,
     *         description="成功返回结构",
     *     ),
