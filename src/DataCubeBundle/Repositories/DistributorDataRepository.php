...
class DistributorDataRepository extends EntityRepository
{
    public $table = "datacube_distributor_data";
    public $cols = ['id','count_date','company_id','distributor_id','member_count','aftersales_count','refunded_count','amount_payed_count','amount_point_payed_count','order_count','order_point_count','order_payed_count','order_point_payed_count','gmv_count','gmv_point_count','merchant_id'];
    /**
     * 新增
     *
     * @param array $data
