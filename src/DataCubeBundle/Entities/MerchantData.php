...
/**
 * MerchantData 商户数据统计表
 *
 * @ORM\Table(
 *    name="datacube_merchant_data",
 *    options={"comment"="商户数据统计表"},
 *    uniqueConstraints={
 *        @ORM\UniqueConstraint(name="ix_date_company", columns={"count_date", "company_id" ,"merchant_id"})
 *    }
 * )
 * @ORM\Entity(repositoryClass="DataCubeBundle\Repositories\MerchantDataRepository")
 */
class MerchantData
{
    /**
