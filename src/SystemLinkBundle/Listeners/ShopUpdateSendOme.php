...
// class ShopUpdateSendOme extends BaseListeners implements ShouldQueue {
class ShopUpdateSendOme extends BaseListeners
{
     ...
     * Handle the event.
     *
     * @param  DistributorUpdateEvent  $event
     * @return void
     */
    public function handle(DistributorUpdateEvent $event)
    {
        app('log')->debug('DistributorUpdateEvent_event:'.var_export($event, 1));
        // 判断是否开启OME
        ...
        try {
            ...
            app('log')->debug('ShopUpdateSendOme_shopStruct=>:'.var_export($shopStruct, 1));
