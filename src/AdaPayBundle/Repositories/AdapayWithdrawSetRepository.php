...
class AdapayWithdrawSetRepository extends EntityRepository
{
    public $table = "Adapay_withdraw_set";
    public $cols = ['id','isAuto','company_id','distributor_id','cash_type','cash_amt','rule','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
