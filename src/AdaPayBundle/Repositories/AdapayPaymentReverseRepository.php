...
class AdapayPaymentReverseRepository extends EntityRepository
{
    public $table = "adapay_payment_reverse";
    public $cols = ['id','company_id','order_id','payment_id','payment_reverse_id','app_id','order_no','reverse_amt','status','request_params','response_params','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        // fe10e2f6 module
        $entity = new AdapayPaymentReverse();
