...
class AdapayWxBusinessCategoryRepository extends EntityRepository
{
    public $table = "adapay_wx_business_category";
    public $cols = ['id','fee_type','fee_type_name','merchant_type_name','business_category_id'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new AdapayWxBusinessCategory();
