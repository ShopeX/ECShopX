...
class AdapayUploadLicenseRepository extends EntityRepository
{
    public $table = "adapay_upload_license";
    public $cols = ['id','company_id','sub_api_key','file_url','file_type','pic_id','error_msg','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new AdapayUploadLicense();
