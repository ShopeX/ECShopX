...
class AdapayMerchantEntryRepository extends EntityRepository
{
    public $table = "adapay_merchant_entry";
    public $cols = ['id','company_id','request_id','usr_phone','cont_name','cont_phone','customer_email','mer_name','mer_short_name','license_code','reg_addr','cust_addr','cust_tel','mer_start_valid_date','mer_valid_date','legal_name','legal_type','legal_idno','legal_mp','legal_start_cert_id_expires','legal_id_expires','card_id_mask','bank_code','card_name','bank_acct_type','prov_code','area_code','rsa_public_key','entry_mer_type','test_api_key','live_api_key','login_pwd','app_id_list','sign_view_url','is_sms','status','error_msg','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new AdapayMerchantEntry();
