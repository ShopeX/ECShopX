...
class AdapayMerchantResidentRepository extends EntityRepository
{
    public $table = "adapay_merchant_resident";
    public $cols = ['id','company_id','request_id','sub_api_key','fee_type','app_id','wx_category','alipay_category','cls_id','model_type','mer_type','province_code','city_code','district_code','add_value_list','status','adapay_fee_mode','alipay_stat','alipay_stat_msg','wx_stat','wx_stat_msg','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new AdapayMerchantResident();
