...
class AdapaySmsLogRepository extends EntityRepository
{
    public $table = "adapay_sms_log";
    public $cols = ['id','company_id','usr_phone','rel_id','type','content','status','error_info','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
