...
class AdapayDrawCashRepository extends EntityRepository
{
    public $table = "adapay_draw_cash";
    public $cols = ['id','company_id','app_id','order_no','adapay_member_id','cash_amt','cash_type','status','request_params','response_params','create_time','update_time','operator_id', 'operator_type','remark','bank_card_id','bank_card_name','cash_id','operator'];
    /**
     * 新增
     *
     * @param array $data
