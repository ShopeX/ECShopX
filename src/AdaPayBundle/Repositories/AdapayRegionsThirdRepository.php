...
class AdapayRegionsThirdRepository extends EntityRepository
{
    public $table = "adapay_regions_third";
    public $cols = ['id','area_name','pid','area_code'];
    /**
     * 新增
     *
     * @param array $data
