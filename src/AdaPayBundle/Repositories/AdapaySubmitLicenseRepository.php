...
class AdapaySubmitLicenseRepository extends EntityRepository
{
    public $table = "adapay_submit_license";
    public $cols = ['id','company_id','sub_api_key','social_credit_code_id','legal_certId_front_id','legal_cert_id_back_id','account_opening_permit_id','business_add','store_id','transaction_test_record_id','web_pic_id','lease_contract_id','settle_account_certificate_id','buss_support_materials_id','icp_registration_license_id','industry_qualify_doc_type','industry_qualify_doc_license_id','shareholder_info_list','is_sms','audit_status','audit_desc','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new AdapaySubmitLicense();
