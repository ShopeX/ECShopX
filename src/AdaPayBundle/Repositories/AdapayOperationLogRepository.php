...
class AdapayOperationLogRepository extends EntityRepository
{
    public $table = "adapay_operation_log";
    public $cols = ['id','company_id','operator_id','rel_id','log_type','content','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
