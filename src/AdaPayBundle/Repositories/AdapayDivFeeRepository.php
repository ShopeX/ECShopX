...
class AdapayDivFeeRepository extends EntityRepository
{
    public $table = "adapay_div_fee";
    public $cols = ['id','trade_id','order_id','company_id','distributor_id','pay_fee','div_fee','adapay_member_id','create_time','update_time','operator_type'];
    /**
     * 新增
     *
     * @param array $data
