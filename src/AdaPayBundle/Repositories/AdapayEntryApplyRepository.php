...
class AdapayEntryApplyRepository extends EntityRepository
{
    public $table = "adapay_entry_apply";
    public $cols = ['id','user_name','company_id','entry_id','apply_type','address','is_sms','status','create_time','update_time','comments'];
    /**
     * 新增
     *
     * @param array $data
