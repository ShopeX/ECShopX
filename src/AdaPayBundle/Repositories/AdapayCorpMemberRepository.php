...
class AdapayCorpMemberRepository extends EntityRepository
{
    public $table = "adapay_corp_member";
    public $cols = ['id','app_id','order_no','member_id','company_id','operator_id','name','prov_code','area_code','social_credit_code','social_credit_code_expires','business_scope','legal_person','legal_cert_id','legal_cert_id_expires','legal_mp','address','zip_code','telphone','email','attach_file','attach_file_name','confirm_letter_file','confirm_letter_file_name','bank_code','bank_acct_type','card_no','card_name','audit_state','audit_desc','create_time','update_time'];
    ...
    public function updateOneBy(array $filter, array $data)
    {
        ...
        if (!$entity) {
            throw new ResourceException("未查询到企业经销商更新数据");
        }
