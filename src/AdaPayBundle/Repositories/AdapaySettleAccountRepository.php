...
class AdapaySettleAccountRepository extends EntityRepository
{
    public $table = "adapay_settle_account";
    public $cols = ['id','app_id','settle_account_id','member_id','company_id','channel','card_id','card_name','cert_id','cert_type','tel_no','bank_code','bank_name','bank_acct_type','prov_code','area_code','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new AdapaySettleAccount();
