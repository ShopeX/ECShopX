...
class AdapayAlipayIndustryCategoryRepository extends EntityRepository
{
    public $table = 'adapay_alipay_industry_category';
    public $cols = ['id', 'category_name', 'parent_id', 'category_level', 'alipay_cls_id', 'alipay_category_id'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function create($data)
    {
        ...
        $entity = new AdapayAlipayIndustryCategory();
