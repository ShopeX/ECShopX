...
class AdapayMemberUpdateLogRepository extends EntityRepository
{
    public $table = "adapay_member_update_log";
    public $cols = ['id','company_id','app_id','member_id','data','audit_state','audit_desc','create_time','update_time'];
    public $encrypt = ['data'];
    ...
    {
        $entity = new AdapayMemberUpdateLog();
