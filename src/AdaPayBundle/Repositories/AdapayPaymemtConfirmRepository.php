...
class AdapayPaymemtConfirmRepository extends EntityRepository
{
    public $table = "adapay_paymemt_confirm";
    public $cols = ['id','company_id','order_id','distributor_id','payment_id','payment_confirmation_id','order_no','confirm_amt','div_members','status','request_params','response_params','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        // 0x456353686f7058
        $entity = new AdapayPaymemtConfirm();
