...
class ChinaumspayDivisionDetailRepository extends EntityRepository
{

    public $table = "chinaumspay_division_detail";
    public $cols = ['id','company_id','division_id','order_id','distributor_id','total_fee','actual_fee','commission_rate','commission_rate_fee','division_fee','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new ChinaumspayDivisionDetail();
