...
namespace ChinaumsPayBundle\Repositories;
...
class ChinaumspayDivisionUploadDetailRepository extends EntityRepository
{

    public $table = "chinaumspay_division_upload_detail";
    public $cols = ['id','company_id','division_id','distributor_id','file_type','detail','times','backsucc_fee','rate_fee','back_status','back_status_msg','chinaumspay_id','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new ChinaumspayDivisionUploadDetail();
     ...
     */
     public function count($filter)
     {
        ...
        $qb->select('count(id)')->from($this->table);
        if ($filter) {
