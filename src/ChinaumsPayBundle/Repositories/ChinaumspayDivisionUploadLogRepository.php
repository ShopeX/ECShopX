...
class ChinaumspayDivisionUploadLogRepository extends EntityRepository
{

    public $table = "chinaumspay_division_upload_log";
    public $cols = ['id','company_id','file_type','local_file_path','remote_file_path','file_name','file_content','back_status','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new ChinaumspayDivisionUploadLog();
