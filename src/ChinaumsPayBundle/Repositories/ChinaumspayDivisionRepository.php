...
class ChinaumspayDivisionRepository extends EntityRepository
{

    public $table = "chinaumspay_division";
    public $cols = ['id','company_id','distributor_id','total_fee','actual_fee','commission_rate_fee','division_fee','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function create($data)
    {
        ...
        $entity = new ChinaumspayDivision();
