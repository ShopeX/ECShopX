...
class ChinaumspayDivisionErrorLogRepository extends EntityRepository
{

    public $table = "chinaumspay_division_error_log";
    public $cols = ['id','company_id','division_id','upload_detail_id','type','order_id','distributor_id','status','error_desc','is_resubmit','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new ChinaumspayDivisionErrorLog();
