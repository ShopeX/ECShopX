 ...
 *         @ORM\Index(name="idx_promoter_user_id", columns={"promoter_user_id"}),
...
class Cart
{
    ...
    */
     ...
     * @var boolean
     *
     * @ORM\Column(name="source_type", type="string", options={"comment":"购物车数据来源：scancode：扫码加入购物车, normal:正常加入购物车,salesperson:业务员导购下单",   "default": "normal"})
     */
