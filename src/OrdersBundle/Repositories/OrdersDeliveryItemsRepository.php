...
class OrdersDeliveryItemsRepository extends EntityRepository
{
    public $table = "orders_delivery_items";
    public $cols = ['orders_delivery_items_id','company_id','order_id','order_items_id','orders_delivery_id','goods_id','item_id','num','item_name','pic','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new OrdersDeliveryItems();
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(orders_delivery_items_id)')
             ->from($this->table);
        if ($filter) {
