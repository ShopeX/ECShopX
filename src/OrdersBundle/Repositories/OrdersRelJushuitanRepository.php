...
class OrdersRelJushuitanRepository extends EntityRepository
{

    public $table = "orders_rel_jushuitan";
    public $cols = ['id','order_id','company_id','o_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
