...
class NormalOrdersRelDadaRepository extends EntityRepository
{
    public $table = "orders_rel_dada";
    public $cols = ['id','order_id','company_id','dada_status','dada_delivery_no','dada_cancel_from','dm_id','dm_name','dm_mobile','pickup_time', 'accept_time','delivered_time','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new NormalOrdersRelDada();
