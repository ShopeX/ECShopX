...
class CompanyRelDadaRepository extends EntityRepository
{
    public $table = "company_rel_dada";
    public $cols = ['id', 'company_id', 'source_id', 'enterprise_name', 'enterprise_address', 'mobile', 'city_name', 'contact_name', 'contact_phone', 'email', 'freight_type', 'bind_type', 'created', 'updated', 'status', 'is_open'];
