...
class OfflinePaymentRepository extends EntityRepository
{

    public $table = "offline_payment";
    public $cols = ['id','order_id','company_id','user_id','shop_id','distributor_id','total_fee','pay_fee','check_status','bank_account_id','bank_account_name','bank_account_no','bank_name','china_ums_no','pay_account_name','pay_account_bank','pay_account_no','pay_sn','voucher_pic','transfer_remark','operator_name','remark','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
