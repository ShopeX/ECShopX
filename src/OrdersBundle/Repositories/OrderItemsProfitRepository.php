...
class OrderItemsProfitRepository extends EntityRepository
{
    public $table = "orders_items_rel_profit";
    public $cols = ['id','order_id','item_id','order_profit_status','company_id','total_fee','profit_type','user_id','dealer_id','distributor_id','order_distributor_id','distributor_nid','seller_id','popularize_distributor_id','popularize_seller_id','proprietary','popularize_proprietary','dealers','distributor','seller','popularize_distributor','popularize_seller','commission','rule'];
    /**
     * 新增
     *
     * @param array $data
