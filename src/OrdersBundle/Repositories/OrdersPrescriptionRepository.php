...
class OrdersPrescriptionRepository extends EntityRepository
{

    public $table = "orders_prescription";
    public $cols = ['id','order_id','diagnosis_id','user_id','company_id','distributor_id','prescription_id','hospital_name','kuaizhen_store_id','kuaizhen_store_name','kuaizhen_diagnosis_id','doctor_sign_time','doctor_office','doctor_id','doctor_name','user_family_name','user_family_phone','user_family_age','user_family_gender','tags','status','memo','remarks','reason','dst_file_path','serial_no','drug_rsp_list','audit_status','audit_time','audit_reason','audit_apothecary_name','is_deleted','delete_time','user_family_id_card','created','updated'];
    /**
     * 新增
     *
     * @param array $data
