...
class OrderInvoiceLogRepository extends EntityRepository
{

    public $table = "orders_invoice_log";
    public $cols = ['id','invoice_id','operator_type','user_id','operator_id','operator_content','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
