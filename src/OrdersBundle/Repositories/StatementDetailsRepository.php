...
class StatementDetailsRepository extends EntityRepository
{
    public $table = 'statement_details';
    public $cols = [
        'id', 'company_id', 'merchant_id', 'distributor_id', 'statement_id', 'statement_no', 
        'order_id', 'total_fee', 'freight_fee', 'intra_city_freight_fee', 
        'supplier_id',
        'rebate_fee', 'refund_fee', 'statement_fee', 'pay_type',
        'num', 'item_fee', 'commission_fee', 'cost_fee', 'point_fee', 
        'refund_num', 'refund_point', 'refund_cost_fee'
    ];
    /**
     * 新增
     *
