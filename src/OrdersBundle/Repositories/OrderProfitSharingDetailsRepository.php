...
class OrderProfitSharingDetailsRepository extends EntityRepository
{
    public $table = "order_profit_sharing_details";
    public $cols = ['order_profit_sharing_detail_id','sharing_id','company_id','order_id','distributor_id','channel_id','channel_acct_id','total_fee','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new OrderProfitSharingDetails();
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(order_profit_sharing_detail_id)')
             ->from($this->table);
        if ($filter) {
