...
class OrderInvoiceItemRepository extends EntityRepository
{

    public $table = "orders_invoice_item";
    public $cols = ['id','user_id','company_id','invoice_id','invoice_apply_bn','order_id','oid','item_name','item_bn','main_img','spec_info','item_spec_desc','num','amount','invoice_tax_rate', 'original_num', 'original_amount', 'create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
