...
class OrdersDiagnosisRepository extends EntityRepository
{

    public $table = "orders_diagnosis";
    public $cols = ['id','order_id','user_id','company_id','kuaizhen_store_id','distributor_id','service_type','is_examine','is_pregnant_woman','is_lactation','souce_from','user_family_name','user_family_id_card','user_family_age','user_family_gender','user_family_phone','relationship','before_ai_data_list','prescription_status','prescription_refuse_reason','status','end_time','cancel_time','doctor_office','doctor_name','hospital_name','first_visit_list','is_deleted','location_url','created','updated'];
    /**
     * 新增
     *
     * @param array $data
