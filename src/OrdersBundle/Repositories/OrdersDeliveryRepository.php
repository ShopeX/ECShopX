...
class OrdersDeliveryRepository extends EntityRepository
{
    public $table = "orders_delivery";
    public $cols = ['orders_delivery_id','company_id','supplier_id','order_id','user_id','delivery_corp','delivery_corp_name','delivery_code',
        'delivery_time','delivery_corp_source','receiver_mobile','package_type','created','updated','self_delivery_operator_id','delivery_remark','delivery_pics'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(orders_delivery_id)')
             ->from($this->table);
        if ($filter) {
