...
class NormalOrdersRelZitiRepository extends EntityRepository
{
    public $table = 'orders_rel_ziti';
    public $cols = ['id', 'company_id', 'order_id', 'name', 'lng', 'lat', 'province', 'city', 'area', 'address', 'contract_phone', 'pickup_date', 'pickup_time', 'created', 'updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new NormalOrdersRelZiti();
