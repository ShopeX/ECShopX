...
class OrderEpidemicRegisterRepository extends EntityRepository
{

    public $table = "order_epidemic_register";
    public $cols = ['id','order_id','user_id','company_id','distributor_id','name','mobile','cert_id','temperature','job','symptom','symptom_des','is_risk_area','is_use','order_time','created','updated'];
    public $encrypt = ['name', 'mobile', 'cert_id'];
    ...
    {
        $entity = new OrderEpidemicRegister();
