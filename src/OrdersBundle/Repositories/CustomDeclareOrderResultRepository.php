...
class CustomDeclareOrderResultRepository extends EntityRepository
{
    public $table = "custom_declare_order_result";
    public $cols = ['order_id','trade_id','state','company_id','transaction_id','sub_order_no','sub_order_id','modify_time','cert_check_result','verify_department','verify_department_trade_id','create_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new CustomDeclareOrderResult();
