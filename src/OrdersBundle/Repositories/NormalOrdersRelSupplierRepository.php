...
class NormalOrdersRelSupplierRepository extends EntityRepository
{
    public $table = 'orders_rel_supplier';
    public $cols = ['id', 'company_id', 'order_id', 'supplier_id', 'freight_fee', 'created'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new NormalOrdersRelSupplier();
