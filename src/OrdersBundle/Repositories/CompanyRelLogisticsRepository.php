...
class CompanyRelLogisticsRepository extends EntityRepository
{
    public $table = "company_rel_logistics";
    public $cols = ['id','corp_id','company_id','corp_code','corp_name', 'distributor_id', 'supplier_id'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new CompanyRelLogistics();
