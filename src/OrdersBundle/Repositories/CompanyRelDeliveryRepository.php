...
class CompanyRelDeliveryRepository extends EntityRepository
{
    public $table = "company_rel_delivery";
    public $cols = ['id','company_id','type','status','rules','other_params','created','updated'];
    /**
     * 新增
     *
     * @param array $data
