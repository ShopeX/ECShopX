...
class RightsOperateLogsRepository extends EntityRepository
{
    /**
     * 新增
     *
    ...
    private function setColumnNamesData($entity, $data)
    {
        ...
        //当前字段非必填
        if (isset($data["original_date"]) && $data["original_date"]) {
            $entity->setOriginalDate($data["original_date"]);
        }
        //当前字段非必填
        if (isset($data["delay_date"]) && $data["delay_date"]) {
            $entity->setDelayDate($data["delay_date"]);
        }
    ...
    private function getColumnNamesData($entity)
    {
        return [
            ...
            'original_date' => $entity->getOriginalDate(),
            'delay_date' => $entity->getDelayDate(),
