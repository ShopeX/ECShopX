...
class OrderProfitSharingRepository extends EntityRepository
{
    public $table = "order_profit_sharing";
    public $cols = ['order_profit_sharing_id','company_id','order_id','distributor_id','user_id','pay_type','channel_id','channel_acct_id','total_fee','status','hf_order_id','hf_order_date','resp_code','resp_desc','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(order_profit_sharing_id)')
             ->from($this->table);
        if ($filter) {
