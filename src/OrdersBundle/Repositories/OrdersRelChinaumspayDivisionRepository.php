...
class OrdersRelChinaumspayDivisionRepository extends EntityRepository
{

    public $table = "orders_rel_chinaumspay_division";
    public $cols = ['id','order_id','company_id','status','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new OrdersRelChinaumspayDivision();
