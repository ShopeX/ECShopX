...
class CompanyRelShansongRepository extends EntityRepository
{
    public $table = "company_rel_shansong";
    public $cols = ['id', 'company_id', 'shop_id', 'client_id', 'app_secret', 'online', 'freight_type', 'is_open', 'created', 'updated'];
