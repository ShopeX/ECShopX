...
class OrderInvoicesRepository extends EntityRepository
{

    public $table = "orders_invoices";
    public $cols = ['id','invoice_id','company_id','invoice_type','invoice_no','invoice_code','invoice_time','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
