...
class EnterpriseEmailBoxRepository extends EntityRepository
{

    public $table = 'employee_purchase_enterprise_email_box';
    public $cols = ['id', 'company_id', 'enterprise_id', 'relay_host', 'smtp_port', 'user', 'password', 'suffix', 'created', 'updated'];
