...
class MemberActivityItemsAggregateRepository extends EntityRepository
{
    public $table = 'employee_purchase_member_activity_items_aggregate';
    public $cols = ['id', 'company_id', 'enterprise_id', 'user_id', 'activity_id', 'item_id', 'aggregate_fee', 'aggregate_num', 'created', 'updated'];
    ...
    {
        $entity = new MemberActivityItemsAggregate();
