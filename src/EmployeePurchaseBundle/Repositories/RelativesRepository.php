...
{
    public $table = 'employee_purchase_relatives';
    public $cols = ['id', 'company_id', 'distributor_id', 'enterprise_id', 'user_id', 'member_mobile', 'activity_id', 'employee_id', 'employee_user_id', 'created', 'disabled'];
