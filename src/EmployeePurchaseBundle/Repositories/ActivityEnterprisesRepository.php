...
class ActivityEnterprisesRepository extends EntityRepository
{
    public $table = 'employee_purchase_activity_enterprises';
    public $cols = ['activity_id', 'enterprise_id', 'company_id'];
    ...
    {
        $entity = new ActivityEnterprises();
