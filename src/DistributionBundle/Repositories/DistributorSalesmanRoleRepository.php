...
class DistributorSalesmanRoleRepository extends EntityRepository
{
    public $table = "distribution_distributor_salesman_role";
    public $cols = ['salesman_role_id','company_id','role_name','rule_ids'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new DistributorSalesmanRole();
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(salesman_role_id)')
             ->from($this->table);
        if ($filter) {
