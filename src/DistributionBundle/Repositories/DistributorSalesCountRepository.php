...
class DistributorSalesCountRepository extends EntityRepository
{
    public $table = "distribution_distributor_sales_count";
    public $cols = ['id','company_id','distributor_id','order_item_count','aftersales_item_count','year_month_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new DistributorSalesCount();
