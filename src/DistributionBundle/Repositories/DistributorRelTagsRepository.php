...
class DistributorRelTagsRepository extends EntityRepository
{
    public $table = "distributor_rel_tags";
    public $cols = ['tag_id','company_id','distributor_id'];
    /**
     * 新增
     *
     * @param array $data
