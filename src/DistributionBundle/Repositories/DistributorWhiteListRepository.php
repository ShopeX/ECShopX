...
class DistributorWhiteListRepository extends EntityRepository
{
    use MagicLangTrait;
    public $table = "distribution_distributor_white_list";
    public $cols = ['id','company_id','distributor_id','mobile','created','updated','username'];
    ...
    {
        $entity = new DistributorWhiteList();
    ...
    public function updateOneBy(array $filter, array $data)
    {
        ...
        $this->getLangService()->updateLangData($data,$this->table,$result['id']);
        return $result;
    }
