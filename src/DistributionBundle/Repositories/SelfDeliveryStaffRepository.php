...
class SelfDeliveryStaffRepository extends EntityRepository
{

    public $table = "self_delivery_staff";
    public $cols = ['id','company_id','operator_id','distributor_id','shop_id','staff_attribute','staff_no','staff_type','payment_method','payment_fee','created','updated'];
    /**
     * 新增
     *
     * @param array $data
     ...
     * @param $filter 更新的条件
     */
    public function getLists($filter, $page = 1, $pageSize = -1, $orderBy = array(), $cols='*')
    {
        $conn = app('registry')->getConnection('default');
