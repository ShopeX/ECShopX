...
class DistributorCategoryRepository extends EntityRepository
{
    public $table = "distribution_distributor_category";
    public $cols = ['category_id', 'company_id', 'category_name', 'category_code', 'created', 'updated'];
    public $prk = 'category_id';
    ...
    {
        $entity = new DistributorCategory();
