...
class TurntableLogRepository extends EntityRepository
{
    public $table = "promotions_turntable_log";
    public $cols = ['id','company_id','user_id','prize_title','prize_type','prize_value','created','act_id'];
    /**
     * 新增
     *
     * @param array $data
     ...
     * @param $filter array
     */
    public function getLists(array $filter, $cols = '*', $page = 1, $pageSize = -1, $orderBy = array())
    {
        $conn = app('registry')->getConnection('default');
