...
class ActiveArticlesRepository extends EntityRepository
{
    public $table = "promotions_active_articles";
    public $cols = ['id','company_id','article_title','article_subtitle','article_content','article_cover','directional_url','is_show','is_delete','sort','created','updated'];
    /**
     * 新增
     *
     * @param array $data
