...
class SpecificCrowdDiscountRepository extends EntityRepository
{
    public $table = "promotions_specific_crowd_discount";
    public $cols = ['id','company_id','specific_type','specific_id','cycle_type','start_time','end_time','discount','limit_total_money', 'status', 'created'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new SpecificCrowdDiscount();
