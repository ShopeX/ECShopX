...
class UserTaskActivityRepository extends EntityRepository
{


    public $table = "user_task_activity";
    public $cols = ['id', 'company_id', 'area_id', 'created', 'updated',
