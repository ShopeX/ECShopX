...
class PackageMainItemRepository extends EntityRepository
{
    public $table = "promotions_package_main_item";
    public $cols = ['package_id','company_id','goods_id','main_item_id','main_item_price'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new PackageMainItemPromotions();
