...
class LimitCategoryRepository extends EntityRepository
{
    public $table = "promotions_limit_category";
    public $cols = ['id','limit_id','category_id','company_id','category_level'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new LimitCategoryPromotions();
