...
class DistributorPromotionsRepository extends EntityRepository
{
    /**
     * 新增
     *
    ...
    {
        $entity = new DistributorPromotions();
    ...
    private function setColumnNamesData($entity, $data)
    {
        ...
        if (isset($data["promotion_type"]) && $data["promotion_type"]) {
            $entity->setPromotionType($data["promotion_type"]);
        }
        if (isset($data["promotion_id"]) && $data["promotion_id"]) {
            $entity->setPromotionId($data["promotion_id"]);
        }
    ...
    private function getColumnNamesData($entity)
    {
        return [
            ...
            'promotion_type' => $entity->getPromotionType(),
            'promotion_id' => $entity->getPromotionId(),
