...
class LimitPersonRepository extends EntityRepository
{
    public $table = "promotions_limit_person";
    public $cols = ['id','limit_id','user_id','item_id','company_id','distributor_id','number','start_time','end_time','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new LimitPersonPromotions();
