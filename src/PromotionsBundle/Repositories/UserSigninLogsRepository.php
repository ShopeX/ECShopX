...
class UserSigninLogsRepository extends EntityRepository
{
    public $table = "user_signin_logs";
    public $cols = ['id','company_id','user_id','from','reward_title','activity_id','reward_text','created','updated'];
    /**
     * 新增
     *
     * @param array $data
     ...
     * @param $filter array
     */
    public function lists(array $filter, $cols = '*', $page = 1, $pageSize = -1, $orderBy = array())
    {
