...
class SpecificCrowdDiscountRelUserRepository extends EntityRepository
{
    public $table = "promotions_scd_rel_user";
    public $cols = ['id','company_id','user_id','order_id','discount_fee','activity_id','specific_id','specific_name','activity_month','action_type','created'];
    ...
    public function create($data)
    {
        ...
        $entity = new SpecificCrowdDiscountRelUser();
