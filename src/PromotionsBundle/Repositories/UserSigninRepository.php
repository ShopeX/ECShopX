...
class UserSigninRepository extends EntityRepository
{
    public $table = "user_signin";
    public $cols = ['id','company_id','user_id','sign_date','created','updated',];
    /**
     * 新增
     *
     * @param array $data
