...
class MarketingActivityCategoryRepository extends EntityRepository
{
    public $table = "promotions_marketing_activity_category";
    public $cols = ['id','marketing_id','category_id','marketing_type','company_id','category_level'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new MarketingActivityCategory();
