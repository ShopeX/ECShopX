...
class MemberPriceRepository extends EntityRepository
{
    public $table = 'promotions_member_price';
    /**
     * 新增
     *
     * @param array $data
    ...
    private function setColumnNamesData($entity, $data)
    {
        if (isset($data["price_id"]) && $data["price_id"]) {
            $entity->setPriceId($data["price_id"]);
        }
        ...
        if (isset($data["mprice"]) && $data["mprice"]) {
            $entity->setMprice($data["mprice"]);
        }
        return $entity;
    }
