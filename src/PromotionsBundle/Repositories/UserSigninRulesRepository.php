...
class UserSigninRulesRepository extends EntityRepository
{
    public $table = "user_signin_rules";
    public $cols = ['id','company_id','rule_name','type','days_required','reward_text','created','updated'];
    /**
     * 新增
     *
     * @param array $data
