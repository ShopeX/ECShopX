...
class UserTaskActivityRuleRepository extends EntityRepository
{
    ...
    //            exit;
    //        }
    public $table = "user_task_activity_rule";
    public $cols = ['id', 'company_id', 'activity_id', 'rule_type', 'rule_name',
        'rule_desc', 'prize_text', 'created','updated','hidde_tag','finish_tag',
        'binding_distributors','binding_category','share_pic','qr_code',
        'frequency','common_condition','rule_detail_type','sign_type'
    ];
    ...
    {
        $entity = new UserTaskActivityRule();
