...
class UserTaskFinishRuleRepository extends EntityRepository
{
    ...
    public $cols = [
        'id', 'company_id', 'activity_id', 'user_id',
        'rule_id','finish_status','created','updated'
    ];
