...
class SalespersonActiveArticleStatisticsRepository extends EntityRepository
{
    public $table = "salesperson_active_article_statistics";
    public $cols = ['id','company_id','salesperson_id','add_date','data_value','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function create($data)
    {
        ...
        $entity = new SalespersonActiveArticleStatistics();
