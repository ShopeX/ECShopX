...
class SalespersonActiveArticleShareLogRepository extends EntityRepository
{
    public $table = "salesperson_active_article_share_log";
    public $cols = ['id','company_id','salesperson_id','article_id','article_title','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function create($data)
    {
        ...
        $entity = new SalespersonActiveArticlesShareLog();
