...
class WxaNoticeTemplateRepository extends EntityRepository
{
    public $table = "promotions_notice_template";
    public $cols = ['id','template_name','wxa_template_id','company_id','notice_type','tmpl_type','template_id','title','scenes_name','content','is_open','send_time_desc','created'];
    /**
     * 新增
     *
     * @param array $data
