...
class ThemeMemberCenterShareRepository extends EntityRepository
{
    public $table = "theme_member_center_share";
    public $cols = ['theme_member_center_share_id','company_id','share_title','share_description','share_pic_wechatapp','share_pic_h5','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new ThemeMemberCenterShare();
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(theme_pc_template_id)')
             ->from($this->table);
        if ($filter) {
