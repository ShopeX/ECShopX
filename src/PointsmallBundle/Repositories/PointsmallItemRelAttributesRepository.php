...
class PointsmallItemRelAttributesRepository extends EntityRepository
{
    public $table = 'pointsmall_items_rel_attributes';
    ...
    {
        $entity = new PointsmallItemRelAttributes();
