...
class PointsmallItemsRelCatsRepository extends EntityRepository
{
    public $table = 'pointsmall_items_rel_cats';
    ...
    {
        $entity = new PointsmallItemsRelCats();
     ...
     * @param $filter 更新的条件
     */
    public function lists($filter, $orderBy = ["created" => "DESC"], $pageSize = 10000, $page = 1)
    {
        $criteria = Criteria::create();
        foreach ($filter as $field => $value) {
            $list = explode("|", $field);
