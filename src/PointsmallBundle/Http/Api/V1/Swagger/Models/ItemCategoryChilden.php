...
/**
 * @SWG\Definition(type="object", @SWG\Xml(name="ItemCategoryChilden"))
 */
class ItemCategoryChilden
{
    /**
    ...
    /**
     * @SWG\Property(description="分类id", example="2")
     * @var int
     */
    public $category_id;

    /**
     * @SWG\Property(description="分类名称", example="类目名称")
     * @var string
     */
