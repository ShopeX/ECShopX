...
/**
 * @SWG\Definition(type="object", @SWG\Xml(name="GoodsDetail"))
 */
class GoodsDetail
{
    public $item_id;
     ...
     * )
     */
    public $item_spec_desc;

    /**
     * @SWG\Property(
     *      type="array",
     *      @SWG\Items(
     *          ref="#/definitions/SpecImages",
     *      )
     *
     * )
     */
    ...
    /**
     * @SWG\Property(description="规格id集合", example="规格id数组")
     * @var string
     */
    public $attribute_ids;

    /**
     * @SWG\Property(description="规格值id和名称对应数组", example="规格值id和名称对应数组")
     * @var string
     */
    public $attr_values_custom;

    /**
     * @SWG\Property(description="商品库存总和", example="197")
     * @var string
     */
    public $item_total_store;
     ...
     *      type="array",
     *      @SWG\Items(
     *          ref="#/definitions/ItemCategoryMain",
     *      )
     *
     * )
     */
    public $item_category_main;
