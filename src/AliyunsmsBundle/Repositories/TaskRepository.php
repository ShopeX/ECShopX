...
{
    public $table = "aliyunsms_task";
    public $cols = ['id','company_id','task_name','user_id','sign_id','template_id','template_name','total_num','failed_num','status', 'send_at','is_send','created','updated'];
    /**
     * 新增
     *
     * @param array $data
