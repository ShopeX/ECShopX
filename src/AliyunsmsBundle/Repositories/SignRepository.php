...
{
    public $table = "aliyunsms_sign";
    public $cols = ['id','company_id','sign_name','sign_source','remark', 'sign_file', 'delegate_file','status', 'reason', 'third_party', 'qualification_id', 'created','updated'];
    
    public $module = 'aliyunsms_sign'; // 多语言对应的模块
    public $primaryKey = 'id'; // 主键，对应data_id
    public $langField = [
        'sign_name','remark','reason'
    ]; // 多语言字段
