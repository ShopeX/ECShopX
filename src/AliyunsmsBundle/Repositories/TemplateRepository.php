...
{
    public $table = "aliyunsms_template";
    public $cols = ['id','company_id','template_name','template_type', 'template_content', 'template_code', 'remark', 'scene_id', 'status','reason', 'related_sign_name', 'created','updated'];
    /**
     * 新增
     *
     * @param array $data
