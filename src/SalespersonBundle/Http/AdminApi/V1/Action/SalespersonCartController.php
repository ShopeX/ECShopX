...
class SalespersonCartController extends Controller
{
    /**
     * @SWG\Post(
     *     path="/admin/wxapp/scancodeAddcart",
     *     summary="扫条形码加入购物车",
     *     tags={"导购"},
     *     description="扫条形码加入购物车",
     *     operationId="scanCodeSales",
     *     @SWG\Parameter( name="x-wxapp-session", in="header", description="导购token", required=true, type="string", default=""),
    ...
    /**
     * @SWG\Get(
     *     path="/admin/wxapp/cartdataupdate",
     *     summary="导购员购物车更新",
     *     tags={"导购"},
     *     description="导购员购物车更新",
    ...
    public function updateCartdata(Request $request)
    {
        ...
        $params['is_checked'] = $request->get('is_checked', true);
        $salespersonCartService = new SalespersonCartService();
        $result = $salespersonCartService->updateCartdata($filter, $params);
        return $this->response->array($result);
    }

    /**
     * @SWG\Get(
     *     path="/admin/wxapp/cartdatalist",
     *     summary="获取导购员购物车",
     *     tags={"导购"},
    ...
    /**
     * @SWG\Get(
     *     path="/admin/wxapp/salesPromotion",
     *     summary="获取导购员促销单",
     *     tags={"导购"},
    ...
    /**
     * @SWG\Get(
     *     path="/admin/wxapp/cartdatadel",
     *     summary="导购员购物车删除",
     *     tags={"导购"},
     *     description="导购员购物车删除",
    ...
    public function delCartdata(Request $request)
    {
        ...
        $salespersonCartService = new SalespersonCartService();
        $result = $salespersonCartService->deleteBy($filter);
