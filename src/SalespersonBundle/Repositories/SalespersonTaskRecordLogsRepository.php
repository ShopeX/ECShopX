...
class SalespersonTaskRecordLogsRepository extends EntityRepository
{
    public $table = "salesperson_task_record_logs";
    public $cols = ['id','company_id','task_id','distributor_id','salesperson_id','remark','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new SalespersonTaskRecordLogs();
