...
class SalespersonCartRepository extends EntityRepository
{
    public $table = "companys_saleperson_cart";
    public $cols = ['cart_id','salesperson_id','item_id','package_items','num','company_id','is_checked','distributor_id'];
    /**
     * 新增
     *
     * @param array $data
