...
class SalespersonStatisticsRepository extends EntityRepository
{
    public $table = "companys_salesperson_statistics";
    public $cols = ['id','company_id','salesperson_id','add_date','statistic_title','statistic_type','data_value','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new SalespersonStatistics();
