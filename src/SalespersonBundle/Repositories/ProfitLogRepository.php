...
class ProfitLogRepository extends EntityRepository
{
    public $table = "companys_profit_log";
    public $cols = ['id','company_id','order_id','profit_user_id','profit_user_type','profit_type','status','income_fee','outcome_fee','remark','params','created'];
    /**
     * 新增
     *
     * @param array $data
