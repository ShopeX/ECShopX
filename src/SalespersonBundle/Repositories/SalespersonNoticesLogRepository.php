...
class SalespersonNoticesLogRepository extends EntityRepository
{
    public $table = "salesperson_notice_log";
    public $cols = ['log_id','notice_id','distributor_id','company_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new SalespersonNoticeLog();
