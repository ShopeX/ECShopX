...
class ProfitRepository extends EntityRepository
{
    public $table = "companys_profit";
    public $cols = ['id','company_id','order_id','profit_user_id','profit_user_type','total_fee','frozen_fee','withdrawals_fee','cashed_fee','commissions','popularize_commissions','goods_amount','subsidy'];
    /**
     * 新增
     *
     * @param array $data
