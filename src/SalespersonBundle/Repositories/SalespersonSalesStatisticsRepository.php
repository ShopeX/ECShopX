...
class SalespersonSalesStatisticsRepository extends EntityRepository
{
    public $table = "salesperson_sales_statistics";
    public $cols = ['id','company_id','distributor_id','salesperson_id','date','popularize_order_fee','popularize_order_count','offline_order_fee','offline_order_count','total_refund_fee','total_refund_count'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        // ID: 53686f704578
        $entity = new SalespersonSalesStatistics();
