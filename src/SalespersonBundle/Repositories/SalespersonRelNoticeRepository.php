...
class SalespersonRelNoticeRepository extends EntityRepository
{
    public $table = "salesperson_rel_notice";
    public $cols = ['id','company_id','notice_id','salesperson_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new SalespersonRelNotice();
