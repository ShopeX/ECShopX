...
class ProfitStatisticsRepository extends EntityRepository
{
    public $table = "companys_profit_statistics";
    public $cols = ['id','date','company_id','profit_user_id','profit_user_type','withdrawals_fee','name','params'];
    /**
     * 新增
     *
     * @param array $data
