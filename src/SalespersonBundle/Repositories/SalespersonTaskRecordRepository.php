...
class SalespersonTaskRecordRepository extends EntityRepository
{
    public $table = "salesperson_task_record";
    public $cols = ['id','company_id','task_id','distributor_id','salesperson_id','times'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new SalespersonTaskRecord();
