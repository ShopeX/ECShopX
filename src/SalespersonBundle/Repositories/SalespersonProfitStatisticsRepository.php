...
class SalespersonProfitStatisticsRepository extends EntityRepository
{
    public $table = "salesperson_profit_statistics";
    public $cols = ['id','company_id','distributor_id','salesperson_id','date','unconfirmed_seller_fee','confirm_seller_fee','unconfirmed_offline_seller_fee','confirm_offline_seller_fee','unconfirmed_popularize_seller_fee','confirm_popularize_seller_fee'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new SalespersonProfitStatistics();
