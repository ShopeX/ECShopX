...
class SalespersonOperatorLogRepository extends EntityRepository
{
    public $table = "salesperson_operator_log";
    public $cols = ['log_id','company_id','distributor_id','operator_id','request_uri','ip','params','operator_name','created'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new SalespersonOperatorLog();
