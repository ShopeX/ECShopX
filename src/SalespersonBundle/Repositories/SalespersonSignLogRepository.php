...
class SalespersonSignLogRepository extends EntityRepository
{
    public $table = "salesperson_signup_log";
    public $cols = ['id', 'company_id', 'salesperson_id', 'distributor_id', 'sign_type'];
    /**
     * 新增
     *
     * @param array $data
