...
class SalespersonNoticeRepository extends EntityRepository
{
    public $table = "salesperson_notice";
    public $cols = ['notice_id','company_id','title','content','distributor_id','all_distributor','notice_type','sent_times','is_delete','withdraw','last_sent_time','created','updated','status'];
    /**
     * 新增
     *
     * @param array $data
