...
class SalespersonTaskRelDistributorRepository extends EntityRepository
{
    public $table = "salesperson_task_rel_distributor";
    public $cols = ['task_id','company_id','distributor_id'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new SalespersonTaskRelDistributor();
