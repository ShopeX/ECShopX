...
class SalespersonLeaderboardDistributorRepository extends EntityRepository
{
    public $table = "salesperson_leaderboard_distributor";
    public $cols = ['id','company_id','date','distributor_id','sales','number'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new LeaderboardDistributor();
