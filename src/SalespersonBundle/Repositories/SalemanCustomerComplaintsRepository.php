...
class SalemanCustomerComplaintsRepository extends EntityRepository
{
    public $table = "companys_saleman_customer_complaints";
    public $cols = ['id','user_id','company_id','user_name','user_mobile','saleman_id','saleman_name','saleman_avatar','saleman_mobile','distributor_id','saleman_distribution_name','complaints_content','complaints_images','reply_status','reply_content','reply_time','reply_operator_id','reply_operator_name','reply_operator_mobile','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new SalemanCustomerComplaint();
