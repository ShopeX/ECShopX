...
class SalespersonRelCouponRepository extends EntityRepository
{
    public $table = "salesperson_rel_coupon";
    public $cols = ['id','company_id','coupon_id','send_num','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new SalespersonRelCoupon();
