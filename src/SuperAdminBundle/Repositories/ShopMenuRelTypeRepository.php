...
class ShopMenuRelTypeRepository extends EntityRepository
{

    public $table = "shop_menu_rel_type";
    public $cols = ['rel_id','shopmenu_id','menu_type','company_id', 'created'];
    /**
     * 新增
     *
     * @param array $data
