...
class CrossBorderSetRepository extends EntityRepository
{
    public $table = "crossborder_set";
    public $cols = ['id','company_id','tax_rate','quota_tip','logistics','crossborder_show','created','updated'];
    /**
     * 新增
     *
     * @param array $data
