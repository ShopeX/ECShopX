...
namespace CrossBorderBundle\Repositories;
...
class OriginCountryRepository extends EntityRepository
{
    public $table = "crossborder_origincountry";
    public $cols = ['origincountry_id','state','company_id','origincountry_name','origincountry_img_url','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(origincountry_id)')
             ->from($this->table);
        if ($filter) {
