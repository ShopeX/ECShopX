...
class CrossBorderIdentityRepository extends EntityRepository
{
    public $table = "crossborder_identity";
    public $cols = ['id','company_id','user_id','identity_id','identity_name','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new CrossBorderIdentity();
