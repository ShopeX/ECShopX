...
use CrossBorderBundle\Entities\Taxstrategy;

use Dingo\Api\Exception\ResourceException;

class CrossborderTaxstrategyRepository extends EntityRepository
{
    public $table = "crossborder_taxstrategy";
    public $cols = ['id','company_id','taxstrategy_name','taxstrategy_content','state','created','updated'];
    /**
     * 新增
     *
     * @param array $data
