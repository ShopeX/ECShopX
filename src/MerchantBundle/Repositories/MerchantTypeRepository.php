...
class MerchantTypeRepository extends EntityRepository
{
    use MagicLangTrait;
    public $table = "merchant_type";
    public $cols = ['id','company_id','name','parent_id','path','sort','is_show','level','created','updated'];
