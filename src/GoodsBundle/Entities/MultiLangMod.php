...
/**
 * multi_lang_mod 多语言语言字典库
 *
 * @ORM\Table(name="multi_lang_mod", options={"comment"="多语言字典库"}, indexes={
 *    @ORM\Index(name="ix_company_id", columns={"company_id"}),
 * }),
 * @ORM\Entity(repositoryClass="GoodsBundle\Repositories\MultiLangModRepository")
 */
class MultiLangMod
{
    /**
