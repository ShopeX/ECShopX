...
class ItemsRelPointAccessRepository extends EntityRepository
{
    public $table = "items_rel_point_access";
    public $cols = ['item_id','company_id','point','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new ItemsRelPointAccess();
