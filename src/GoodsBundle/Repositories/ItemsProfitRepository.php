...
class ItemsProfitRepository extends EntityRepository
{
    public $table = "items_profit";
    public $cols = ['item_id','company_id','profit_type','profit_conf'];
    /**
     * 新增
     *
     * @param array $data
