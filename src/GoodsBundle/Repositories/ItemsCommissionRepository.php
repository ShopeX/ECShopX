...
class ItemsCommissionRepository extends EntityRepository
{

    public $table = "items_commission";
    public $cols = ['id','company_id','rel_id','type','commission_type','commission_conf'];
    /**
     * 新增
     *
     * @param array $data
