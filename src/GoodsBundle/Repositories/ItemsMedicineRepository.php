...
class ItemsMedicineRepository extends EntityRepository
{

    public $table = "items_medicine";
    public $cols = ['item_id','company_id','medicine_type','common_name','dosage','spec','packing_spec','manufacturer','approval_number','unit','is_prescription','special_common_name','special_spec','audit_status','audit_reason','item_type','use_tip','symptom','max_num','created','updated'];
    /**
     * 新增
     *
     * @param array $data
