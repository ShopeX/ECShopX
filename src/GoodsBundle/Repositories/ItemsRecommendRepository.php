...
class ItemsRecommendRepository extends EntityRepository
{
    public $table = "items_recommend";
    public $cols = ['id','main_item_id','item_id','company_id','item_name','brief','pics','price','market_price','item_spec_desc','sort'];
    /**
     * 新增
     *
     * @param array $data
