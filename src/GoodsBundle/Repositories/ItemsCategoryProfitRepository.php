...
class ItemsCategoryProfitRepository extends EntityRepository
{
    public $table = "items_category_profit";
    public $cols = ['category_id','company_id','profit_type','profit_conf'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function create($data)
    {
        ...
        $entity = new ItemsCategoryProfit();
