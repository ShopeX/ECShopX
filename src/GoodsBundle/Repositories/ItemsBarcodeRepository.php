...
class ItemsBarcodeRepository extends EntityRepository
{
    public $table = "items_barcode";
    public $cols = ['item_id','company_id','barcode','default_item_id'];
    /**
     * 新增
     *
     * @param array $data
