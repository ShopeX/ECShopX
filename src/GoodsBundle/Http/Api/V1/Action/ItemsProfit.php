...
class ItemsProfit extends Controller
{
    /**
     * @SWG\post(
     *     path="/goods/profit/save",
     *     summary="保存商品导购分润价格配置",
     *     tags={"商品"},
     *     description="保存商品导购分润价格配置",
     *     operationId="saveGoodsProfit",
     *     @SWG\Parameter( name="Authorization", in="header", description="JWT验证token", required=true, type="string"),
     *     @SWG\Parameter( name="profit_conf", in="query", description="请求参数，以下参数在该参数下，数组对象", required=true, type="string"),
     *     @SWG\Parameter( name="item_id", in="query", description="商品ID", required=true, type="string"),
     *     @SWG\Parameter( name="profit_type", in="query", description="分润类型", required=true, type="string"),
     ...
     * )
     */
    public function saveGoodsProfit(Request $request)
    {
    ...
    /**
     * @SWG\get(
     *     path="/goods/profit/{item_id}",
     *     summary="获取商品导购分润价格配置",
     *     tags={"商品"},
     *     description="获取商品导购分润价格配置",
     *     operationId="getItemsProfit",
     *     @SWG\Parameter( name="Authorization", in="header", description="JWT验证token", required=true, type="string"),
     ...
     * )
     */
    public function getItemsProfit($item_id)
    {
        ...
        $params['company_id'] = app('auth')->user()->get('company_id');
        $itemsProfitService = new ItemsProfitService();
        $result = $itemsProfitService->getItemsProfit($params);
