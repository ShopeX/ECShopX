...
class CommunityActivityItemRepository extends EntityRepository
{
    public $table = "community_activity_item";
    public $cols = ['id','activity_id','goods_id','item_id','item_name', 'item_spec_desc','item_brief','item_pics',
        'price','cost_price','market_price','store'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new CommunityActivityItem();
