...
class CommunityOrderRelActivityRepository extends EntityRepository
{
    public $table = 'community_order_rel_activity';
    public $cols = ['order_id', 'company_id', 'chief_id', 'chief_name', 'chief_avatar', 'activity_id', 'activity_name', 'ziti_name', 'ziti_address', 'ziti_lng', 'ziti_lat', 'ziti_contact_user', 'ziti_contact_mobile', 'activity_trade_no', 'extra_data', 'rebate_ratio'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new CommunityOrderRelActivity();
