...
class CommunityChiefZitiRepository extends EntityRepository
{
    public $table = "community_chief_ziti";
    public $cols = ['ziti_id','chief_id','ziti_name','province','city','area','regions_id','regions',
        'address','lat','lng','ziti_contact_user','ziti_contact_mobile','ziti_pics','is_default','ziti_status','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
