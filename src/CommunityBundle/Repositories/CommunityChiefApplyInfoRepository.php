...
class CommunityChiefApplyInfoRepository extends EntityRepository
{
    public $table = 'community_chief_apply_info';
    public $cols = ['apply_id', 'company_id', 'distributor_id', 'user_id', 'chief_name', 'chief_mobile', 'extra_data', 'approve_status', 'refuse_reason'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new CommunityChiefApplyInfo();
