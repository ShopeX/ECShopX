...
class CommunityActivityZitiRepository extends EntityRepository
{
    public $table = "community_activity_ziti";
    public $cols = ['id','activity_id','ziti_id','condition_num','remark'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new CommunityActivityZiti();
