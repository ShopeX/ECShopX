...
class CommunityChiefDistributorRepository extends EntityRepository
{
    public $table = "community_chief_distributor";
    public $cols = ['id','chief_id','distributor_id', 'bound_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new CommunityChiefDistributor();
