...
class TopicRepository extends EntityRepository
{
    ...
    public $table = "wsugc_topic";
    public $cols = ['topic_id','topic_name','created','p_order','is_top','user_id','company_id','enabled','status','operator_id','source','updated','ai_verify_time','manual_verify_time','manual_refuse_reason','ai_refuse_reason'];
    
    public $module = 'wsugc_topic'; // 多语言对应的模块
    public $primaryKey = 'topic_id'; // 主键，对应data_id
    public $langField = [
        'topic_name','ai_refuse_reason','manual_refuse_reason'
    ]; // 多语言字段
