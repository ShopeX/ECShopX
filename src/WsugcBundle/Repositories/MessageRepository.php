...
class MessageRepository extends EntityRepository
{
    ...
    public $table = "wsugc_message";
    public $cols = ['message_id','title','content','created','updated','from_user_id','from_nickname','to_user_id','to_nickname','company_id','hasread','source','type','sub_type','comment_id','post_id'];
    /**
     * 新增
     *
     * @param array $data
