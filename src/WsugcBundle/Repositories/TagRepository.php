...
class TagRepository extends EntityRepository
{
    ...
    public $table = "wsugc_tag";
    public $cols = ['tag_id','tag_name','created','p_order','user_id','company_id','enabled','status','operator_id','source','updated','ai_verify_time','manual_verify_time','manual_refuse_reason','ai_refuse_reason'];
    /**
     * 新增
     *
     * @param array $data
