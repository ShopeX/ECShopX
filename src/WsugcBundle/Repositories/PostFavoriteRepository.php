...
class PostFavoriteRepository extends EntityRepository
{
    public $table = "wsugc_post_favorite";
    public $cols = ['post_favorite_id','post_id','user_id','disabled','created','updated'];
    /**
     * 新增
     *
     * @param array $data
     ...
     */
     public function count($filter)
     {
         ...
         $qb->select('count(post_favorite_id)')
             ->from($this->table);
         if ($filter) {
