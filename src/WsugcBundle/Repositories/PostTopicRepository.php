...
class PostTopicRepository extends EntityRepository
{

    public $table = "wsugc_post_topic";
    public $cols = ['topic_id','post_id','created','company_id'];
