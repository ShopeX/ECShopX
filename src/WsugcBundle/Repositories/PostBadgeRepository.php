...
class PostBadgeRepository extends EntityRepository
{

    public $table = "wsugc_post_badge";
    public $cols = ['badge_id','post_id','created','company_id'];
    /**
     * 新增
     *
     * @param array $data
