...
class BadgeRepository extends EntityRepository
{
    ...
    public $table = "wsugc_badge";
    public $cols = ['badge_id','badge_name','badge_memo','created','p_order','is_top','user_id','company_id','enabled','status','operator_id','source','updated','ai_verify_time','manual_verify_time','manual_refuse_reason','ai_refuse_reason'];
   
    public $module = 'wsugc_badge'; // 多语言对应的模块
    public $primaryKey = 'badge_id'; // 主键，对应data_id
    public $langField = [
        'badge_name','badge_memo','ai_refuse_reason','manual_refuse_reason'
    ]; // 多语言字段
