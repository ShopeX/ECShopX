...
{
    public $table = "wsugc_comment";
    public $cols = ['comment_id','post_id','user_id','parent_comment_id','reply_comment_id','reply_user_id','content','likes','ip','province','city','district','p_order','status','enable','disabled','company_id','created','updated','ai_verify_time','manual_verify_time','ai_refuse_reason','manual_refuse_reason'];
    public $module = 'wsugc_comment'; // 多语言对应的模块
    public $primaryKey = 'comment_id'; // 主键，对应data_id
    public $langField = [
        'content','province','city','district','ai_refuse_reason','manual_refuse_reason'
    ]; // 多语言字段
