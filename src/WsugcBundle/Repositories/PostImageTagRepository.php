...
use WsugcBundle\Entities\YuyueVerify;
...
class YuyueVerifyRepository extends EntityRepository
{

    public $table = "yuyue_verify";
    public $cols = ['verify_id','agent_id','record_id','member_id','verify_member_id','activity_fulltime','createtime','memo','company_id','activity_id'];
    /**
     * 新增
     *
     * @param array $data
