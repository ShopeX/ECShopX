...
class EmailService
{
    ...
    {
        if ($from) {
            $this->smtp_port = $from['email_smtp_port'];
            $this->relay_host = $from['email_relay_host'];
            $this->user = $from['email_user'];
            $this->sender = $from['email_user'];
            $this->pass = $from['email_password']; 
        } else {
            ...
            $this->sender = config('common.email_sender');
