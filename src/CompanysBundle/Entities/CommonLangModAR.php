...
/**
 * common_lang_mod_ar 多语言语言字典库
 *
 * @ORM\Table(name="common_lang_mod_ar", options={"comment"="多语言字典库"}, indexes={
 *    @ORM\Index(name="ix_company_id", columns={"company_id"}),
 * }),
 * @ORM\Entity(repositoryClass="CompanysBundle\Repositories\CommonLangModARRepository")
 */
class CommonLangModAR
{
    /**
     * @var integer
     *
