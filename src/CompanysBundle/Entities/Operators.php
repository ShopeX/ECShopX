...
class Operators
{
    ...
    * @var string
    *
    * @ORM\Column(name="operator_type", type="string", options={"comment":"操作员类型类型。admin:超级管理员;staff:员工;distributor:店铺管理员;dealer:经销商;merchant:商户;supplier:供应商;self_delivery_staff:自配送员", "default": "admin"})
    */
