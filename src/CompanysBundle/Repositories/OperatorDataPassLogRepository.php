...
class OperatorDataPassLogRepository extends EntityRepository
{
    public $table = "operator_data_pass_log";
    public $cols = ['log_id','company_id','operator_id','create_time','path','url'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function create($data)
    {
        ...
        $entity = new OperatorDataPassLog();
