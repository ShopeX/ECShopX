...
use CompanysBundle\Entities\CommonLangModCN;

class CommonLangModCNRepository extends EntityRepository
{
    public $table = "common_lang_mod_cn";
    public $cols = [
