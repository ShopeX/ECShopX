...
class DistributorWechatRelRepository extends EntityRepository
{
    public $table = "distributor_wechat_rel";
    public $cols = ['id','company_id','app_id', 'app_type', 'openid', 'unionid','operator_id','bound_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new DistributorWechatRel();
