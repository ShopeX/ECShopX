...
use CompanysBundle\Entities\CommonLangModAR;

class CommonLangModARRepository extends EntityRepository
{
    public $table = "common_lang_mod_ar";
    public $cols = [
        'id','company_id','distributor_id','module_name','table_name','lang','attribute_value','data_id',
        'field',
        'created','updated'
    ];
