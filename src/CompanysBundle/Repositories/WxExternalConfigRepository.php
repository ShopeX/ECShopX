...
class WxExternalConfigRepository extends EntityRepository
{
    public $table = "wx_external_config";
    public $cols = ['wx_external_config_id','company_id','app_id','app_name','app_desc','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(wx_external_config_id)')
             ->from($this->table);
        if ($filter) {
