...
class WxExternalRoutesRepository extends EntityRepository
{
    public $table = "wx_external_routes";
    public $cols = ['wx_external_routes_id','company_id','wx_external_config_id','route_name','route_info','route_desc','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(wx_external_routes_id)')
             ->from($this->table);
        if ($filter) {
