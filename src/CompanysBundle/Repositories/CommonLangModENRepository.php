...
use CompanysBundle\Entities\CommonLangModEN;

class CommonLangModENRepository extends EntityRepository
{
    public $table = "common_lang_mod_en";
    public $cols = [
