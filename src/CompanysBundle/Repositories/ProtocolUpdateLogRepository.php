...
class ProtocolUpdateLogRepository extends EntityRepository
{
    public $table = 'companys_protocol_update_log';
    /**
     * 新增
     *
     * @param array $data
