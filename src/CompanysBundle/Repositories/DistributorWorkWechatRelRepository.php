...
class DistributorWorkWechatRelRepository extends EntityRepository
{
    public $table = "distributor_work_wechat_rel";
    public $cols = ['id','company_id','work_userid','operator_id','bound_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new DistributorWorkWechatRel();
