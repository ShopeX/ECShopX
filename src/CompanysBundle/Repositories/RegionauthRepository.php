...
class RegionauthRepository extends EntityRepository
{
    public $table = "companys_regionauth";
    public $cols = ['regionauth_id','regionauth_name','state','company_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
