...
class OperatorPendingOrderRepository extends EntityRepository
{
    public $table = "companys_operator_pending_order";
    public $cols = ['pending_id','company_id','distributor_id','operator_id','user_id','pending_type','pending_data','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new OperatorPendingOrder();
