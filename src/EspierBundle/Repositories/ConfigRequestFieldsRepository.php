...
class ConfigRequestFieldsRepository extends EntityRepository
{
    use MagicLangTrait;
    public $table = "config_request_fields";
    public $cols = ['id','company_id','distributor_id','module_type','label','key_name','is_open','is_required','is_edit','is_preset','field_type','validate_condition','alert_required_message','alert_validate_message','created','updated'];
    ...
    public function create($data)
    {
        ...
        $entity = new ConfigRequestFields();
    ...
    public function getLists($filter, $cols = '*', $page = 1, $pageSize = -1, $orderBy = array())
    {
        ...
        $lang = $this->getLang();
        $lists = (new MultiLangService())->getListAddLang($lists,$this->multiLangField,$this->table,$lang,$this->prk);
        return $lists;
    }
