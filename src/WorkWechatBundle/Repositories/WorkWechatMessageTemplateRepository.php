...
class WorkWechatMessageTemplateRepository extends EntityRepository
{
    public $table = "work_wechat_message_template";
    public $cols = ['id','company_id','template_id','disabled','emphasis_first_item','title','description','content'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new WorkWechatMessageTemplate();
