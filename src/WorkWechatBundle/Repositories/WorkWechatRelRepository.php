...
class WorkWechatRelRepository extends EntityRepository
{
    public $table = "work_wechat_rel";
    public $cols = ['id','company_id','work_userid','salesperson_id','external_userid','unionid','user_id','is_friend','is_bind','bound_time', 'add_friend_time'];
    /**
     * 新增
     *
     * @param array $data
