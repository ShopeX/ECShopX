...
class WorkWechatMessageManagerTemplateRepository extends EntityRepository
{
    public $table = "work_wechat_message_manager_template";
    public $cols = ['id', 'template_id', 'disabled', 'title', 'description'];
