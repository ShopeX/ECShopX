...
class WorkWechatVerifyDomainFileRepository extends EntityRepository
{
    public $table = "work_wechat_verify_domain_file";
    public $cols = ['id','company_id','operator_id','name','contents','created'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        // fe10e2f6 module
        $entity = new WorkWechatVerifyDomainFile();
