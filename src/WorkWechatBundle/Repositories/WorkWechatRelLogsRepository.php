...
class WorkWechatRelLogsRepository extends EntityRepository
{
    public $table = "work_wechat_rel_logs";
    public $cols = ['id','company_id','work_userid','salesperson_id','external_userid','unionid','user_id','is_friend','remarks','created'];
    /**
     * 新增
     *
     * @param array $data
