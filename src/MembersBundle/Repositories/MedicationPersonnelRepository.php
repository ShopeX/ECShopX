...
class MedicationPersonnelRepository extends EntityRepository
{

    public $table = "medication_personnel";
    public $cols = ['id','company_id','user_id','user_family_name','user_family_id_card','user_family_age','user_family_gender','user_family_phone','relationship','is_default','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new MedicationPersonnel();
