...
class MemberOperateLogRepository extends EntityRepository
{
    /**
     * 新增
     *
    ...
    private function setColumnNamesData($entity, $data)
    {
        ...
        if (isset($data["operate_type"]) && $data["operate_type"]) {
            $entity->setOperateType($data["operate_type"]);
        }
        if (isset($data["remarks"]) && $data["remarks"]) {
            $entity->setRemarks($data["remarks"]);
        }
        if (isset($data["old_data"]) && $data["old_data"]) {
            $entity->setOldData($data["old_data"]);
        }
        if (isset($data["new_data"]) && $data["new_data"]) {
            $entity->setNewData($data["new_data"]);
        }
        if (isset($data["operater"]) && $data["operater"]) {
    ...
    private function getColumnNamesData($entity)
    {
        return [
            ...
            'operate_type' => $entity->getOperateType(),
            'remarks' => $entity->getRemarks(),
            'old_data' => $entity->getOldData(),
            'new_data' => $entity->getNewData(),
