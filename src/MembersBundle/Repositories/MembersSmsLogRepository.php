...
class MembersSmsLogRepository extends EntityRepository
{
    /**
     * 新增
     *
    ...
    private function setColumnNamesData($entity, $data)
    {
        ...
        if (isset($data["send_to_phones"]) && $data["send_to_phones"]) {
            $entity->setSendToPhones(implode(',', $data["send_to_phones"]));
        }
        if (isset($data["sms_content"]) && $data["sms_content"]) {
            $entity->setSmsContent($data["sms_content"]);
        }
    ...
    private function getColumnNamesData($entity)
    {
        return [
            ...
            'send_to_phones' => explode(',', $entity->getSendToPhones()),
            'sms_content' => $entity->getSmsContent(),
