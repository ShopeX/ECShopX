...
class MemberRemarksRepository extends EntityRepository
{
    public $table = "member_remarks";
    public $cols = ['remarks_id','company_id','salesperson_id','user_id','remarks','created','updated'];
    /**
     * 新增
     *
     * @param array $data
