...
class MemberRelGroupRepository extends EntityRepository
{
    public $table = "member_rel_group";
    public $cols = ['id','group_id','company_id','salesperson_id','user_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
