...
class MembersDeleteRecordRepository extends EntityRepository
{
    public $table = "members_delete_record";
    public $cols = ['id','company_id','user_id','mobile','created'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new MembersDeleteRecord();
