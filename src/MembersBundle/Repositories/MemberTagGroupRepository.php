...
class MemberTagGroupRepository extends EntityRepository
{
    public $table = "members_tag_groups";
    public $cols = ['group_id', 'group_name', 'description', 'company_id', 'distributor_id', 'created', 'updated'];
    private $prk = 'group_id';
     ...
     * 根据条件获取列表数据
     */
    public function lists($filter, $cols = '*', $page = 1, $pageSize = -1, $orderBy = array('created' => 'DESC'))
    {
