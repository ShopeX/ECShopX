...
class TagsCategoryRepository extends EntityRepository
{
    public $table = "members_tags_category";
    public $cols = ['category_id','category_name','sort','company_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
     ...
     * @param $filter 更新的条件
     */
    public function getLists($filter, $cols = '*', $page = 1, $pageSize = -1, $orderBy = array('sort' => 'DESC', 'category_id' => 'DESC'))
    {
        $conn = app('registry')->getConnection('default');
