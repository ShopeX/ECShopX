...
class MembersInvoicesRepository extends EntityRepository
{
    public $table = "members_invoices";
    public $cols = ['invoices_id','company_id','user_id','invoices_type','name','telephone','tax_number','business_address','bank','bank_account','is_def','created','updated'];
    /**
     * 新增
     *
     * @param array $data
