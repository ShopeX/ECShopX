...
class MemberTagGroupRelRepository extends EntityRepository
{
    public $table = "members_tag_group_rel";
    public $cols = ['id', 'group_id', 'tag_id', 'company_id', 'distributor_id', 'created'];
     ...
     * 根据条件获取列表数据
     */
    public function getLists($filter, $cols = '*', $page = 1, $pageSize = -1, $orderBy = array('created' => 'DESC'))
    {
        $conn = app('registry')->getConnection('default');
