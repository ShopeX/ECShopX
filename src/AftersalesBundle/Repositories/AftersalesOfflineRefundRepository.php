...
class AftersalesOfflineRefundRepository extends EntityRepository
{

    public $table = "aftersales_offline_refund";
    public $cols = ['id','refund_bn','order_id','company_id','refund_fee','bank_account_name','bank_account_no','bank_name','refund_account_name','refund_account_bank','refund_account_no','create_time','update_time'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function create($data)
    {
        ...
        $entity = new AftersalesOfflineRefund();
