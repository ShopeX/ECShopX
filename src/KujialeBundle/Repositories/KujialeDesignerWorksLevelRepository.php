...
class KujialeDesignerWorksLevelRepository extends EntityRepository
{

    public $table = "kujiale_designer_works_level";
    public $cols = ['id','design_id','plan_id','spec_name','src_area','area','real_area','plan_pic','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new KujialeDesignerWorksLevel();
