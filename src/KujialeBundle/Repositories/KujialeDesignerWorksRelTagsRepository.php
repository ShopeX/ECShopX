...
class KujialeDesignerWorksRelTagsRepository extends EntityRepository
{

    public $table = "kujiale_designer_works_rel_tags";
    public $cols = ['id','tag_category_id','tag_category_name','tag_id','tag_name','design_id','plan_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new KujialeDesignerWorksRelTags();
