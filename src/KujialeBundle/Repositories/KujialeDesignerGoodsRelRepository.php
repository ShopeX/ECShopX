...
class KujialeDesignerGoodsRelRepository extends EntityRepository
{

    public $table = "kujiale_designer_goods_rel";
    public $cols = ['id','pic_id','obs_brand_good_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new KujialeDesignerGoodsRel();
