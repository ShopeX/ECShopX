...
class KujialeDesignerTagsRepository extends EntityRepository
{

    public $table = "kujiale_designer_tags";
    public $cols = ['id','tag_category_id','tag_category_name','type','is_multiple_selected','is_disabled','tag_id','tag_name','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new KujialeDesignerTags();
