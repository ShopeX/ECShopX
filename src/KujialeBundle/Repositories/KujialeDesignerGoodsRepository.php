...
class KujialeDesignerGoodsRepository extends EntityRepository
{

    public $table = "kujiale_designer_goods";
    public $cols = ['id','good_id','dimensions','description','brand_good_code','brand_good_name','brand_id','brand_name','series_tag_id','series_tag_name','product_number','customer_texture','buy_link','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new KujialeDesignerGoods();
