...
class KujialeDesignerWorksItemRelRepository extends EntityRepository
{

    public $table = "kujiale_designer_works_item_rel";
    public $cols = ['id', 'item_id', 'design_id', 'goods_bn', 'created', 'updated'];
    ...
    {
        $entity = new KujialeDesignerWorksItemRel();
