...
use KujialeBundle\Entities\KujialeDesignerWorksRelCities;
...
class KujialeDesignerWorksRelCitiesRepository extends EntityRepository
{

    public $table = "kujiale_designer_works_rel_cities";
    public $cols = ['id','design_id','plan_id','city_id','created','updated'];
    ...
    {
        $entity = new KujialeDesignerWorksRelCities();
    ...
    /**
     * 根据design_id和plan_id删除所有关联的城市记录
     *
     * @param string $designId
     * @param string $planId
     */
    public function deleteByDesignAndPlan($designId, $planId)
    {
        $filter = [
            'design_id' => $designId,
            'plan_id' => $planId,
