...
class KujialeDesignerWorksLikeRepository extends EntityRepository
{

    public $table = "kujiale_designer_works_like";
    public $cols = ['id','design_id','plan_id','user_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new KujialeDesignerWorksLike();
