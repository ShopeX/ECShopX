...
class KujialeDesignerWorksPicRepository extends EntityRepository
{

    public $table = "kujiale_designer_works_pic";
    public $cols = ['id','pic_id','pic_type','pic_detail_type','room_name','img','pano_link','design_id','plan_id','level','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new KujialeDesignerWorksPic();
