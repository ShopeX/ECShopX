...
class HfpayLedgerConfigRepository extends EntityRepository
{
    public $table = "hfpay_ledger_config";
    public $cols = ['hfpay_ledger_config_id','company_id','is_open','business_type','agent_number','provider_number','rate','app_id','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(hfpay_ledger_config_id)')
             ->from($this->table);
        if ($filter) {
