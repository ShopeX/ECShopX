...
class HfpayMerchantPaymentRepository extends EntityRepository
{
    public $table = "hfpay_merchant_payment";
    public $cols = ['hfpay_merchant_payment_id','company_id','rel_scene_id','rel_scene_name','mer_cust_id','user_cust_id','acct_id','trans_amt','status','hf_order_id','hf_order_date','resp_code','resp_desc','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new HfpayMerchantPayment();
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(hfpay_merchant_payment_id)')
             ->from($this->table);
        if ($filter) {
