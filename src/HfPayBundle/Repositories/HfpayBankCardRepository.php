...
class HfpayBankCardRepository extends EntityRepository
{
    public $table = "hfpay_bank_card";
    public $cols = ['hfpay_bank_card_id','company_id','distributor_id','user_id','user_cust_id','card_type','bank_id','bank_name','card_num','bind_card_id','is_cash','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(hfpay_bank_card_id)')
             ->from($this->table);
        if ($filter) {
