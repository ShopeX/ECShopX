...
class HfpayWithdrawSetRepository extends EntityRepository
{
    public $table = "Hfpay_withdraw_set";
    public $cols = ['hfpay_withdraw_set_id','company_id','withdraw_method','distributor_money','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(hfpay_withdraw_set_id)')
             ->from($this->table);
        if ($filter) {
