...
class HfpayTradeRecordRepository extends EntityRepository
{
    public $table = "hfpay_trade_record";
    public $cols = ['hfpay_trade_record_id','company_id','distributor_id','trade_id','outer_order_id','form_user_id','target_user_id','trade_time','trade_type','fin_type','income','outcome','is_clean','clean_time','message','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(hfpay_trade_record_id)')
             ->from($this->table);
        if ($filter) {
