...
class HfpayDistributorStatisticsDayRepository extends EntityRepository
{
    public $table = "hfpay_distributor_statistics_day";
    public $cols = ['hf_distributor_day_id','company_id','distributor_id','date','income','disburse','withdrawal','balance','withdrawal_balance','unsettled_funds','refund','settlement_funds','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new HfpayDistributorStatisticsDay();
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(hf_distributor_day_id)')
             ->from($this->table);
        if ($filter) {
