...
class HfpayCompanyStatisticsDayRepository extends EntityRepository
{
    public $table = "hfpay_company_statistics_day";
    public $cols = ['hfpay_company_day_id','company_id','type','date','income','disburse','withdrawal','balance','withdrawal_balance','unsettled_funds','refund','settlement_funds','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new HfpayCompanyStatisticsDay();
    ...
    public function count($filter)
    {
        ...
        $qb->select('count(hfpay_company_day_id)')
             ->from($this->table);
        if ($filter) {
