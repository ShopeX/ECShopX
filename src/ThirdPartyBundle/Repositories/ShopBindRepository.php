...
class ShopBindRepository extends EntityRepository
{
    public $table = "thirdparty_shop_bind";
    public $cols = ['id','company_id','name','node_id','node_type','status','created','updated'];
    /**
     * 新增
     *
     * @param array $data
