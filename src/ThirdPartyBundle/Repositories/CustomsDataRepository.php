...
class CustomsDataRepository extends EntityRepository
{
    public $table = "customs_data";
    public $cols = ['order_id','session_id','service_time','status'];
    /**
     * 新增
     *
     * @param array $data
