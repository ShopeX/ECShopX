...
class MapConfigServiceRepository extends EntityRepository
{
    public $table = "map_config_service";
    public $cols = ['id','company_id','config_id','type','service_id','service_data','status','created','updated'];
    /**
     * 新增
     *
     * @param array $data
