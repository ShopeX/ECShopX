...
class MapConfigRepository extends EntityRepository
{
    public $table = "map_config";
    public $cols = ['id','company_id','type','app_key','app_secret','is_default','created','updated'];
    /**
     * 新增
     *
     * @param array $data
