...
namespace ThirdPartyBundle\Repositories;
...
class CompanyRelKuaizhenRepository extends EntityRepository
{

    public $table = "company_rel_kuaizhen";
    public $cols = ['id','company_id','client_id','client_secret','online','is_open','kuaizhen_store_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
