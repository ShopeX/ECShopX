...
class SaasErpLogRepository extends EntityRepository
{
    public $table = "thirdparty_saaserp_log";
    public $cols = ['id','company_id','api_type','worker','params','result','status','runtime','msg_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
