...
/**
 * queueLog (saasErp通信日志)
 *
 * @ORM\Table(name="thirdparty_saaserp_log", options={"comment"="联通saasErp通信日志"})
 * @ORM\Entity(repositoryClass="ThirdPartyBundle\Repositories\SaasErpLogRepository")
 */
class SaasErpLog
{
    /**
