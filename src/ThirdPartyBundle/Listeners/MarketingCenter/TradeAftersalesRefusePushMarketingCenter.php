...
class TradeAftersalesRefusePushMarketingCenter
{
    use GetOrderServiceTrait;
    /**
     * Handle the event.
     *
     * @param TradeAftersalesRefuseEvent $event
     * @return void
     */
    public function handle(TradeAftersalesRefuseEvent $event)
    {
        // Debug: 1e2364
...
//        if ($salesmanInfo) {
        $input['sale_salesperson_id'] = $salesmanInfo['work_userid'] ?? '';
//        }
//        if ($bindSalesmanInfo) {
        $input['bind_salesperson_id'] = $bindSalesmanInfo['work_userid'] ?? '';
//        }
