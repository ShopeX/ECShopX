...
class CardPackageItemsRepository extends EntityRepository
{
    public $table = "card_package_items";
    public $cols = ['id','package_id','company_id','card_id','give_num','created','updated'];
    /**
     * 新增
     *
     * @param array $data
