...
class CardPackageReceiveRecordRepository extends EntityRepository
{
    public $table = "card_package_receive_record";
    public $cols = ['id','company_id','user_id','grade_id','trigger_type','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new CardPackageReceiveRecord();
