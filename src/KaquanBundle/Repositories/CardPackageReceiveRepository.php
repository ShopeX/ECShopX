...
class CardPackageReceiveRepository extends EntityRepository
{
    public $table = "card_package_receive";
    public $cols = ['receive_id','package_id','company_id','user_id','receive_type','receive_status','front_show','receive_time','success_count','created','updated'];
    /**
     * 新增
     *
     * @param array $data
