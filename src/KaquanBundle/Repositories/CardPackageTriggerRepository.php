...
class CardPackageTriggerRepository extends EntityRepository
{
    public $table = "card_package_trigger";
    public $cols = ['id','package_id','company_id','trigger_type','association_id','created','updated'];
    /**
     * 新增
     *
     * @param array $data
