...
class CardPackageReceiveDetailsRepository extends EntityRepository
{
    public $table = "card_package_receive_details";
    public $cols = ['id','receive_id','package_id','company_id','user_id','card_id','message','receive_status','created','updated'];
    /**
     * 新增
     *
     * @param array $data
    ...
    {
        $entity = new CardPackageReceiveDetails();
