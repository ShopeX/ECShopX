...
class VipGradeRelUserRepository extends EntityRepository
{
    public $table = "kaquan_vip_rel_user";
    ...
    private function setColumnNamesData($entity, $data)
    {
        ...
        if (isset($data["vip_type"]) && $data["vip_type"]) {
            $entity->setVipType($data["vip_type"]);
        }
        //当前字段非必填
