...
class DivFeeRepository extends EntityRepository
{

    public $table = "bspay_div_fee";
    public $cols = ['id','trade_id','order_id','company_id','distributor_id','operator_type',
        'supplier_id',
        'pay_fee','div_fee','huifu_id','created','updated','merchant_id'];
    /**
     * 新增
     *
     * @param array $data
