...
class PaymemtConfirmRepository extends EntityRepository
{

    public $table = "bspay_paymemt_confirm";
    public $cols = ['id','company_id','order_id','distributor_id','payment_id','payment_confirmation_id','order_no','confirm_amt','div_members','status','request_params','response_params','created','updated'];
    /**
     * 新增
     *
     * @param array $data
