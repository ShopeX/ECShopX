...
class UserUpdateLogRepository extends EntityRepository
{

    public $table = "bspay_user_update_log";
    public $cols = ['id','company_id','sys_id','huifu_id','user_type','user_id','data','audit_state','audit_desc','created','updated'];
    /**
     * 新增
     *
     * @param array $data
