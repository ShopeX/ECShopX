...
class UserIndvRepository extends EntityRepository
{

    public $table = "bspay_user_indv";
    public $cols = ['id','req_seq_id','sys_id','huifu_id','company_id','is_update','name','cert_no','cert_validity_type','cert_begin_date','cert_end_date','mobile_no','audit_state','audit_desc','error_info','created','updated'];
    /**
     * 新增
     *
     * @param array $data
