...
class EntryApplyRepository extends EntityRepository
{

    public $table = "bspay_entry_apply";
    public $cols = ['id','user_name','company_id','user_id','operator_id','operator_type','user_type','address','comments','status','created','updated'];
    /**
     * 新增
     *
     * @param array $data
