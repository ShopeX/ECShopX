...
class UserEntRepository extends EntityRepository
{

    public $table = "bspay_user_ent";
    public $cols = ['id','req_seq_id','sys_id','huifu_id','company_id','is_update','reg_name','license_code','license_validity_type','license_begin_date','license_end_date','reg_prov_id','reg_area_id','reg_district_id','reg_detail','legal_name','legal_cert_no','legal_cert_validity_type','legal_cert_begin_date','legal_cert_end_date','contact_name','contact_mobile','ent_type','audit_state','audit_desc','error_info','created','updated'];
    /**
     * 新增
     *
     * @param array $data
