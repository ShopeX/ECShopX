...
class PromoterIdentityRepository extends EntityRepository
{

    public $table = "popularize_promoter_identity";
    public $cols = ['id','company_id','name','is_subordinates','is_default','created','updated'];
    /**
     * 新增
     *
     * @param array $data
