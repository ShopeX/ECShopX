...
namespace OpenapiBundle\Repositories;
...
class OpenapiDeveloperRepository extends EntityRepository
{
    public $table = "openapi_developer";
    public $cols = ['developer_id','company_id','app_key','app_secret','external_base_uri','external_app_key','external_app_secret','created_at','updated_at'];
    /**
     * 新增
     *
     * @param array $data
