...
class SupplierGoodsUploadService
{
    ...
    {
        $salesCategoryMulti = '运动户外->系列->城市休闲|运动户外->系列->徒步&穿越|运动户外->系列->野外跑步|运动户外->系列->登山&攀岩|运动户外->系列->单双板滑雪|运动户外->系列->配件';
        $data = [
            [
                'item_main_category' => '运动户外->品类->配件',
                'item_name' => '官方认证 普通滑雪护目镜',
                'goods_bn' => 'PC26011800000037',
                'item_bn' => 'KC26011800000037',
                'brief' => '品质保障，售后无忧',
                'price' => '58',
                'market_price' => '0',
                'cost_price' => '30',
                ...
                'videos' => '',
                'goods_brand' => '户外运动品牌',
                'templates_id' => '按件数-供应商',
                'item_category' => '运动户外->系列->单双板滑雪|运动户外->系列->配件',
                'weight' => '0',
                'barcode' => '',
                'item_unit' => '',
                'item_spec' => '',
            ...
            [
                'item_main_category' => '运动户外->品类->配件',
                'item_name' => '官方认证 无檐帽',
                'goods_bn' => 'PC26011800000029',
                'item_bn' => 'KC26011800000031',
                'brief' => '',
                'price' => '3.99',
                'market_price' => '0',
                'cost_price' => '2',
                ...
                'goods_brand' => '户外运动品牌',
                'templates_id' => '按件数-供应商',
                'item_category' => $salesCategoryMulti,
                'weight' => '0',
                'barcode' => '',
                'item_unit' => '',
                'item_spec' => '颜色:天蓝色',
            ...
            [
                ...
                'item_name' => '',
                'item_bn' => '',
                'brief' => '2为一条单规格商品，3-5为一条多规格商品  此文件为模拟数据，使用该模板请删除本句，重新修改数据。',
            ],
        ];
