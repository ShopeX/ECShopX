...
class PaypalTest extends TestCase
{
    ...
    public function testExample()
    {
        ...
        $companyId = 1;
        $config= [
          'client_id' => 'AVQNIgbrsj2qgTFTAkV_Sn7dmUU2Eaqh9U0j-J4-18iTXcv-XwccZGrT6bQfxzmnPQasQmY2MF-PFqeS',
          'client_secret' => 'EB9yNqeckLc39mQMbhZG1oXucZVXT5NYuuvNZoSlwuBnomiBxTghnHFnMaDQ9jhay1Y1Ob1LpIi2YzHD',
          'sandbox' => true,
          'webhook_id' => 12,
          'is_open' => true,
        ];
