...
const VALID_CLIENTS = new Set<string>(['api', 'cli', 'cursor-cli', 'sdk'])
...
export class Config {
  ...
  constructor(options?: ConfigOptions) {
    ...
    this.useSystemCursor = this.getUseSystemCursor(options)
  ...
  private getUseSystemCursor(options?: ConfigOptions): boolean {
    return options?.useSystemCursor ?? process.env.USE_SYSTEM_CURSOR === 'true'
  }
